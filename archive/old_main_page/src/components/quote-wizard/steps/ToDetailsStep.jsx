  ...
  return (
    <>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16, maxWidth: 700, margin: '0 auto' }}>
          ...
          <div className="qw-field" style={{ gridColumn: '1 / span 2' }}><label className="qw-label">Special items</label><input className="qw-input" placeholder="Large items, fragile, etc." /></div>
        </div>
    </>
  );
}
