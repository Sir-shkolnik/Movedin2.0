    ...
    MapboxGeocoder.prototype = {
      ...
      onAdd: function(map) {
        ...
        typeahead.list.draw = function() {
          if (self2.options.useBrowserFocus) {
            typeahead.list.element.querySelectorAll("li").forEach(function(item) {
              item.removeEventListener("focus", self2._onSuggestionItemFocus);
              item.removeEventListener("keydown", self2._onSuggestionItemKeyDown);
            });
          }
