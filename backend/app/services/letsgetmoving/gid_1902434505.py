"""
WINDSOR (GID 1902434505) - Specialized Parser
...
def parse_gid_1902434505(rows: List[List[str]]) -> Dict[str, Any]:
    ...
    logger.info(f"✅ WINDSOR: Extracted {len(daily_rates)} daily rates")
